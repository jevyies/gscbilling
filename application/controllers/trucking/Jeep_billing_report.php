...
class Jeep_Billing_Report extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $records = array(
            'records' => $this->jeep_report_model->get_billing_report($data),
        ...
        if($this->get('excel')){
            $html = $this->load->view('Jeep_Billing_Report', $records);
        }else{
            $html = $this->load->view('Jeep_Billing_Report', $records, true);
        }
        $mpdf = new \Mpdf\Mpdf([
            'default_font_size' => 9,
            'default_font' => 'tahoma',
