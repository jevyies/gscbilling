...
class PHB_Standard_Report extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        $records = array(
            'records' => $this->phb_report_model->get_standard_report($data),
        ...
        if($this->get('excel')){
            $html = $this->load->view('PHB_Standard_Report', $records);
        }else{
            $html = $this->load->view('PHB_Standard_Report', $records, true);
        }
        $mpdf = new \Mpdf\Mpdf([
            'default_font_size' => 9,
            'default_font' => 'tahoma',
