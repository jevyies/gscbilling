...
class Rate extends REST_Controller {
    ...
    public function index_get(){
        if($this->get('sar')){
            $result = $this->rate_model->get_sar();
        }elseif($this->get('bcc')){
            $result = $this->rate_model->get_bcc();
        }elseif($this->get('slers')){
            $result = $this->rate_model->get_slers();
        }elseif($this->get('clubhouse')){
            $result = $this->rate_model->get_clubhouse();
        }elseif($this->get('construction')){
            $result = $this->rate_model->get_construction();
        }elseif($this->get('displayUploads')){
            $result = $this->rate_model->display_uploaded_rate();
        }else{
            $result = $this->rate_model->get_data();
        }
        $this->returns($result);
    }
    ...
    public function index_post(){
        if($this->post('sar')){
            ...
            $result = $this->rate_model->post_sar($data);
            ...
            $result = $this->rate_model->post_bcc($data);
            if(gettype($result) ===  "array"){
                $result = array(
                    'success' => true,
                    'id' => $result['id'],
            ...
            $result = $this->rate_model->post_slers($data);
            if(gettype($result) ===  "array"){
                $result = array(
                    'success' => true,
                    'id' => $result['id'],
            ...
            $result = $this->rate_model->post_clubhouse($data);
            if(gettype($result) ===  "array"){
                $result = array(
                    'success' => true,
                    'id' => $result['id'],
            ...
            $result = $this->rate_model->post_construction($data);
            if(gettype($result) ===  "array"){
                $result = array(
                    'success' => true,
                    'id' => $result['id'],
            ...
            $result = $this->rate_model->upload_dar($this->post('list'));
            if($result){
                $result = array(
                    'success' => true,
                    'message' => 'Successfully inserted'
            ...
            $result = $this->rate_model->finalize_upload_dar();
            if($result){
                $result = array(
                    'success' => true,
            ...
            $result = $this->rate_model->reactivate_rate($this->post('id'));
            if($result){
                $result = array(
                    'success' => true,
            ...
            $result = $this->rate_model->delete_dar($this->post('id'));
            if($result){
                $result = array(
                    'success' => true,
        ...
        }elseif($this->post('deleteCONSTRUCTION')){
            $result = $this->rate_model->delete_construction($this->post('id'));
            if($result){
                $result = array(
                    'success' => true,
                    'message' => 'Successfully deleted'
            ...
            $data = [
                ...
                'rd_nd' => $this->post('rd_nd') ? $this->post('rd_nd') : '',
                'rd_ndot' => $this->post('rd_ndot') ? $this->post('rd_ndot') : '',
                'rt_st' => $this->post('rt_st') ? $this->post('rt_st') : '',
                'rt_ot' => $this->post('rt_ot') ? $this->post('rt_ot') : '',
                'rt_nd' => $this->post('rt_nd') ? $this->post('rt_nd') : '',
                'rt_ndot' => $this->post('rt_ndot') ? $this->post('rt_ndot') : '',
                'shol_st' => $this->post('shol_st') ? $this->post('shol_st') : '',
                'shol_ot' => $this->post('shol_ot') ? $this->post('shol_ot') : '',
                'shol_nd' => $this->post('shol_nd') ? $this->post('shol_nd') : '',
                'shol_ndot' => $this->post('shol_ndot') ? $this->post('shol_ndot') : '',
            ...
            $result = $this->rate_model->post_dar($data);
            if(gettype($result) ===  "array"){
                $result = array(
                    'success' => true,
                    'id' => $result['id'],
    ...
    public function index_delete(){
        $result = $this->rate_model->delete_data($this->query('id'));
        if ($result){
            $result = array(
                'success' => true,
                'message' => 'Successfully deleted'
