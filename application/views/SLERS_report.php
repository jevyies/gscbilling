...
$filename = 'GSCSLERS-'. date('mdY') .'.xls';
...
$total_rhol_ot2x_s = 0;
$total_rhol_nd2x_s = 0;
$total_rhol_ndot2x_s = 0;
$total_rholrd_st2x_s = 0;
$total_rholrd_ot2x_s = 0;
$total_rholrd_nd2x_s = 0;
$total_rholrd_ndot2x_s = 0;
        ...
        <table width="100%" class="main_t">
            <thead>
                <tr>
                    ...
                    <td colspan="5" style="text-align:center;">AMOUNT</td>
            ...
            <tbody>
                ...
                <?php if($last_activity != $record->Activity): ?>
                <tr>
                    <td colspan="2"style="text-align:left;border:none;font-weight:bold;">SUB-TOTAL</td>
                    <td colspan="2"style="text-align:center;border:none;font-weight:bold;"><?php echo $last_activity; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rd_st_s != 0 ? number_format($total_rd_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rd_ot_s != 0 ? number_format($total_rd_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rd_nd_s != 0 ? number_format($total_rd_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rd_ndot_s != 0 ? number_format($total_rd_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shol_st_s != 0 ? number_format($total_shol_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shol_ot_s != 0 ? number_format($total_shol_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shol_nd_s != 0 ? number_format($total_shol_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shol_ndot_s != 0 ? number_format($total_shol_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_holiday_pay_s != 0 ? number_format($total_holiday_pay_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_st_s != 0 ? number_format($total_rhol_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_ot_s != 0 ? number_format($total_rhol_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_nd_s != 0 ? number_format($total_rhol_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_ndot_s != 0 ? number_format($total_rhol_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shrd_st_s != 0 ? number_format($total_shrd_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shrd_ot_s != 0 ? number_format($total_shrd_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shrd_nd_s != 0 ? number_format($total_shrd_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_shrd_ndot_s != 0 ? number_format($total_shrd_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhrd_st_s != 0 ? number_format($total_rhrd_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhrd_ot_s != 0 ? number_format($total_rhrd_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhrd_nd_s != 0 ? number_format($total_rhrd_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhrd_ndot_s != 0 ? number_format($total_rhrd_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_st2x_s != 0 ? number_format($total_rhol_st2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_ot2x_s != 0 ? number_format($total_rhol_ot2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_nd2x_s != 0 ? number_format($total_rhol_nd2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rhol_ndot2x_s != 0 ? number_format($total_rhol_ndot2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rholrd_st2x_s != 0 ? number_format($total_rholrd_st2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rholrd_ot2x_s != 0 ? number_format($total_rholrd_ot2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rholrd_nd2x_s != 0 ? number_format($total_rholrd_nd2x_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_rholrd_ndot2x_s != 0 ? number_format($total_rholrd_ndot2x_s, 2, '.', ',') : ""; ?></td>
                    <td colspan="28" style="border:none;"></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_st_s != 0 ? number_format($total_st_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_hp_s != 0 ? number_format($total_hp_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_ot_s != 0 ? number_format($total_ot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_nd_s != 0 ? number_format($total_nd_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_ndot_s != 0 ? number_format($total_ndot_s, 2, '.', ',') : ""; ?></td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_st_s + $total_hp_s + $total_ot_s + $total_nd_s + $total_ndot_s != 0 ? number_format($total_st_s + $total_ot_s + $total_nd_s + $total_ndot_s, 2, '.', ',') : ""; ?></td>
                </tr>
                <?php
                    $last_activity = $record->Activity;
                    $total_rd_st_s = 0;
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><?php echo number_format(($record->holiday_pay * $record->rd_st_r), 2, '.', ','); ?></td>
                    ...
                    <td style="text-align:right;"><?php echo number_format(($record->rd_ndot * $record->rd_ndot_r) + ($record->shol_ndot * $record->shol_ndot_r) + ($record->rhol_ndot * $record->rhol_ndot) + ($record->shrd_ndot * $record->shrd_ndot_r) + ($record->rhrd_ndot * $record->rhrd_ndot_r) + ($record->rhol_ndot2x * $record->rhol_ndot2x_r) + ($record->rholrd_ndot2x * $record->rholrd_ndot2x_r), 2, '.', ','); ?></td>
                ...
                $total_hp = $total_hp + ($record->holiday_pay * $record->rd_st_r);
                ...
                $total_ndot = $total_ndot + ($record->rd_ndot * $record->rd_ndot_r) + ($record->shol_ndot * $record->shol_ndot_r) + ($record->rhol_ndot * $record->rhol_ndot) + ($record->shrd_ndot * $record->shrd_ndot_r) + ($record->rhrd_ndot * $record->rhrd_ndot_r) + ($record->rhol_ndot2x * $record->rhol_ndot2x_r) + ($record->rholrd_ndot2x * $record->rholrd_ndot2x_r);
                
                $total_rd_st_s = $total_rd_st_s + $record->rd_st;
                $total_rd_ot_s = $total_rd_ot_s + $record->rd_ot;
                $total_rd_nd_s = $total_rd_nd_s + $record->rd_nd;
                $total_rd_ndot_s = $total_rd_ndot_s + $record->rd_ndot;
                $total_shol_st_s = $total_shol_st_s + $record->shol_st;
                $total_shol_ot_s = $total_shol_ot_s + $record->shol_ot;
                $total_shol_nd_s = $total_shol_nd_s + $record->shol_nd;
                $total_shol_ndot_s = $total_shol_ndot_s + $record->shol_ndot;
                $total_holiday_pay_s = $total_holiday_pay_s + $record->holiday_pay;
                $total_rhol_st_s = $total_rhol_st_s + $record->rhol_st;
                $total_rhol_ot_s = $total_rhol_ot_s + $record->rhol_ot;
                $total_rhol_nd_s = $total_rhol_nd_s + $record->rhol_nd;
                $total_rhol_ndot_s = $total_rhol_ndot_s + $record->rhol_ndot;
                $total_shrd_st_s = $total_shrd_st_s + $record->shrd_st;
                $total_shrd_ot_s = $total_shrd_ot_s + $record->shrd_ot;
                $total_shrd_nd_s = $total_shrd_nd_s + $record->shrd_nd;
                $total_shrd_ndot_s = $total_shrd_ndot_s + $record->shrd_ndot;
                $total_rhrd_st_s = $total_rhrd_st_s + $record->rhrd_st;
                $total_rhrd_ot_s = $total_rhrd_ot_s + $record->rhrd_ot;
                $total_rhrd_nd_s = $total_rhrd_nd_s + $record->rhrd_nd;
                $total_rhrd_ndot_s = $total_rhrd_ndot_s + $record->rhrd_ndot;
                $total_rhol_st2x_s = $total_rhol_st2x_s + $record->rhol_st2x;
                $total_rhol_ot2x_s = $total_rhol_ot2x_s + $record->rhol_ot2x;
                $total_rhol_nd2x_s = $total_rhol_nd2x_s + $record->rhol_nd2x;
                $total_rhol_ndot2x_s = $total_rhol_ndot2x_s + $record->rhol_ndot2x;
                $total_rholrd_st2x_s = $total_rholrd_st2x_s + $record->rholrd_st2x;
                $total_rholrd_ot2x_s = $total_rholrd_ot2x_s + $record->rholrd_ot2x;
                $total_rholrd_nd2x_s = $total_rholrd_nd2x_s + $record->rholrd_nd2x;
                $total_rholrd_ndot2x_s = $total_rholrd_ndot2x_s + $record->rholrd_ndot2x;
                $total_st_s = $total_st_s + ($record->holiday_pay * $record->rd_st_r) + ($record->rd_st * $record->rd_st_r) + ($record->shol_st * $record->shol_st_r) + ($record->rhol_st * $record->rhol_st_r) + ($record->shrd_st * $record->shrd_st_r) + ($record->rhrd_st * $record->rhrd_st_r) + ($record->rhol_st2x * $record->rhol_st2x_r) + ($record->rholrd_st2x * $record->rholrd_st2x_r);
                $total_hp_s = $total_hp_s + ($record->holiday_pay * $record->rd_st_r);
                $total_ot_s = $total_ot_s + ($record->rd_ot * $record->rd_ot_r) + ($record->shol_ot * $record->shol_ot_r) + ($record->rhol_ot * $record->rhol_ot_r) + ($record->shrd_ot * $record->shrd_ot_r) + ($record->rhrd_ot * $record->rhrd_ot_r) + ($record->rhol_ot2x * $record->rhol_ot2x_r) + ($record->rholrd_ot2x * $record->rholrd_ot2x_r);
                $total_nd_s = $total_nd_s + ($record->rd_nd * $record->rd_nd_r) + ($record->shol_nd * $record->shol_nd_r) + ($record->rhol_nd * $record->rhol_nd_r) + ($record->shrd_nd * $record->shrd_nd_r) + ($record->rhrd_nd * $record->rhrd_nd_r) + ($record->rhol_nd2x * $record->rhol_nd2x_r) + ($record->rholrd_nd2x * $record->rholrd_nd2x_r);
                $total_ndot_s = $total_ndot_s + ($record->rd_ndot * $record->rd_ndot_r) + ($record->shol_ndot * $record->shol_ndot_r) + ($record->rhol_ndot * $record->rhol_ndot) + ($record->shrd_ndot * $record->shrd_ndot_r) + ($record->rhrd_ndot * $record->rhrd_ndot_r) + ($record->rhol_ndot2x * $record->rhol_ndot2x_r) + ($record->rholrd_ndot2x * $record->rholrd_ndot2x_r);
                ...
                <tr>
                    ...
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_hp != 0 ? number_format($total_hp, 2, '.', ',') : ""; ?></td>
                    ...
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_st + $total_hp + $total_ot + $total_nd + $total_ndot != 0 ? number_format($total_st + $total_ot + $total_nd + $total_ndot, 2, '.', ',') : ""; ?></td>
                </tr>
                <?php if($admin_percentage != 0): ?>
                <tr>
                    <td colspan="64" style="border:none;text-align:right">Amount Billed (<?php echo $admin_percentage ?>% Admin Fee) (<?php echo number_format(($total_st + $total_hp + $total_ot + $total_nd + $total_ndot) * ($admin_percentage/100), 2, '.', ','); ?>):</td>
                    <td style="text-align:right;border:none;border-bottom:3px solid black;"><?php echo $total_st + $total_hp + $total_ot + $total_nd + $total_ndot != 0 ? number_format($total_st + $total_hp + $total_ot + $total_nd + $total_ndot + (($total_st + $total_hp + $total_ot + $total_nd + $total_ndot) * ($admin_percentage/100)), 2, '.', ',') : ""; ?></td>
                </tr>
                <?php endif; ?>
                <?php endif; ?>
            </tbody>
