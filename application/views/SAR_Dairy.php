    ...
    <body>
        ...
        <table style="margin-bottom:20px;table-layout:fixed;width:100%" class="table-fix">
            <tr>
                ...
                <th style="width:12%;background:#7bbbf3;" colspan="2">Accomplishment</th>
            ...
            <tr>
                ...
                <th style="padding:10px 0;background:#c1c1c1;width:6%;">Field # / Cost Center</th>
                <th style="padding:10px 0;background:#c1c1c1;width:6%;">Qty</th>
                <th style="padding:10px 0;background:#c1c1c1;">Unit</th>
                <th style="padding:10px 0;background:#c1c1c1;">Rate</th>
            ...
            <tr>
                ...
                <td colspan="2" style="border:none;border-bottom:2px solid black;background:#c1c1c1;"><strong><i style="font-size:150%;">Grand Total</i></strong></td>
                <td style="border:none;text-align:right;border-bottom:2px solid black;background:#c1c1c1;"><strong style="font-size:150%;"><?php echo number_format($grand_total, 2, '.', ',');?></strong></td>
            </tr>
        </table>
        <table width="100%">
            <tr>
