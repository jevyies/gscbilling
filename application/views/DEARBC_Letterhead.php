	...
	<html xmlns:x="urn:schemas-microsoft-com:office:excel">
		...
		<body>
			...
			<table width="100%">
				...
				<tr>
					<td style="width:80%;font-size:120%;"><?php echo $detail->paystation; ?></td>
					<td style="width:20%;text-align:right;font-size:120%;"><?php echo number_format($detail->sumTotal, 2, '.', ','); ?></td>
				</tr>
				<?php $total = $total + $detail->sumTotal; ?>
				<?php endforeach; ?>
				<tr>
					<td style="width:60%;font-size:120%;">AMOUNTING TO: </td>
					<td style="width:35%;text-align:right;font-weight:bold;border-top:3px solid black;font-size:120%;">Php <?php echo number_format($total, 2, '.', ','); ?></td>
				</tr>
			</table>
			<?php endif; ?>
			<br>
