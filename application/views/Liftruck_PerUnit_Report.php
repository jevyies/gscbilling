		...
		<body>
			...
			<table width="100%" class="main_t">
				...
				<tbody>
                    ...
                    <?php $balance = $record->amount - $record->collected; ?>
                    <tr style="border:1px solid black;">
                        <td style="text-align:center;"><?php echo $record->date; ?></td>
                        <td style="text-align:center;"><?php echo $record->delivery_no; ?></td>
                        ...
                        <td style="text-align:right;"><?php echo number_format((float)$record->collected, 2, '.', ','); ?></td>
