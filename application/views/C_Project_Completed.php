<?php 
    ...
    $filename = 'ProjectCompleted-'. date('mdY') .'.xls';
			...
			<table width="100%">
				<tr>
					<td style="width:100%;text-align:center;">
						...
						<h3 style="text-align:center;text-decoration:underline;">COMPLETED PROJECTS (<?php echo $from . '-' . $to; ?>)</h3>
					</td>
				</tr>
			</table><br><br>
			<table width="100%" class="main_t">
				<thead>
					...
					<tr style="background:lightgreen;">
						...
						<th style="width:10%;padding:20px 0;">P.O no.</th>
						<th style="width:10%;padding:20px 0;">Total Amount</th>
						<th style="width:10%;padding:20px 0;">Contracted Labor</th>
						<th style="width:10%;padding:20px 0;">Professional Fee</th>
						<th style="width:10%;padding:20px 0;">Gov't remittance</th>
						<th style="width:10%;padding:20px 0;">Fuel</th>
						<th style="width:10%;padding:20px 0;">Driver</th>
						<th style="width:10%;padding:20px 0;">CLERK</th>
						<th style="width:10%;padding:20px 0;">Materials</th>
						<th style="width:10%;padding:20px 0;">MEAL/HAUL</th>
						<th style="width:10%;padding:20px 0;">TOTAL EXPENSES</th>
						<th style="width:10%;padding:20px 0;">Net/Loss</th>
						<th style="width:10%;padding:20px 0;">STARTED</th>
						<th style="width:10%;padding:20px 0;">COMPLETED</th>
						<th style="width:10%;padding:20px 0;">BILLED</th>
				...
				<tbody>
					...
					<tr>
						...
						<td style="text-align:center;padding:5px;"><?php echo date('d-m-Y', strtotime($record['completed'])); ?></td>
