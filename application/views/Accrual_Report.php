                        ...
                        <?php foreach($hdr['dtls'] as $record): ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    ...
                                    <td><?php echo $record->Location; ?></td>
                                    <td><?php echo $record->soaNumber; ?></td>
                                    <td><?php echo number_format($rdst_total + $sholst_total + $shrdst_total + $rholst_total + $rhrdst_total, 2, '.', ','); ?></td>
                                    <td><?php echo number_format($rdot_total + $sholot_total + $shrdot_total + $rholot_total + $rhrdot_total, 2, '.', ','); ?></td>
                                    <td><?php echo number_format($rdnd_total + $sholnd_total + $shrdnd_total + $rholnd_total + $rhrdnd_total, 2, '.', ','); ?></td>
                                    <td><?php echo number_format($rdndot_total + $sholndot_total + $shrdndot_total + $rholndot_total + $rhrdndot_total, 2, '.', ','); ?></td>
