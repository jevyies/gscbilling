<?php 
    ...
    $filename = 'VanRental Payroll Report -'. date('mdY') .'.xls';
			...
			<table width="100%" class="main_t">
				<thead>
					<tr style="border:1px solid black;">
						...
						<th style="text-align:center;" rowspan="4">SOA NO.</th>
						<th style="text-align:center;" rowspan="4">Remarks</th>
						<th style="text-align:center;" colspan="6">VAN RENTAL</th>
						<th style="text-align:center;"></th>
                        <th style="text-align:center;" colspan="19">GSC SHOP</th>
                        <th style="text-align:center;" rowspan="4">GROSS INCOME</th>
                    </tr>
                    <tr>
                        <th style="text-align:center;" rowspan="3">AMOUNT</th>
                        <th style="text-align:center;" colspan="4">DEDUCTIONS</th>
                        <th style="text-align:center;" rowspan="3">NET FROM DEDUCTIONS</th>
                        <th style="text-align:center;" rowspan="2">TOTAL</th>
                        <th style="text-align:center;" colspan="9">HOURS RENDERED</th>
                        <th style="text-align:center;" colspan="4">RATE/HR (REGULAR DAY)</th>
                        <th style="text-align:center;" colspan="2">RATE/HR (SUN/SHOL DAY)</th>
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;" colspan="4">REGULAR DAY</th>
                        ...
                        <th style="text-align:center;" >NDOT</th>
                        <th style="text-align:center;" >ST</th>
                        <th style="text-align:center;" >OT</th>
                        <th style="text-align:center;" >ST</th>
                        <th style="text-align:center;" >OT</th>
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;">ST</th>
                        <th style="text-align:center;">OT</th>
                        <th style="text-align:center;">43.60</th>
                        <th style="text-align:center;">54.50</th>
                        <th style="text-align:center;">4.36</th>
                        <th style="text-align:center;">5.45</th>
                        <th style="text-align:center;">56.68</th>
                        <th style="text-align:center;">73.69</th>
                        <th style="text-align:center;">87.21</th>
                        <th style="text-align:center;">109.01</th>
                        <th style="text-align:center;">43.60</th>
                    </tr>
				</thead>
                <tbody>
                    ...
                    <?php foreach($records as $record): ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo $record->SOANo ? $record->SOANo : 'N/A'; ?></td>
                            <td style="text-align:center;"><?php echo $record->po_activity; ?></td>
